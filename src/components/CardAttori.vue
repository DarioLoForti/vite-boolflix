...
export default {
    ...
    methods:{
        ...
        // METODO PER INSERIRE SCROLLARE LA LISTA DEGLI ATTORI
...
<template lang="">
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h3 v-if= store.view >Popular Actor</h3>
                </div>
                <div class="my-card-col">
                    <div class="my-card my-2 px-2" v-for="actor, index in store.attori" :key="index">      
                        <div class="flip-card my-4" >
                            <div class="flip-card-inner">
                                <div class="flip-card-front">
                                    <img class="posterImg" :src="`https://image.tmdb.org/t/p/w342/${ actor.profile_path }`" alt="">
                                </div>
                                <div class="flip-card-back p-4">
                                    <h5> Nome: <br>
                                        {{ actor.name }}
                                    </h5>
                                    <h6> Ruolo: {{actor.known_for_department}} </h6>
                                </div>
                            </div>
                        </div>   
                    </div>
